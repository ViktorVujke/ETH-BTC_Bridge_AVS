...
func AbiEncodeMintTaskResponse(h *cstaskmanager.IIncredibleSquaringTaskManagerTaskResponse) ([]byte, error) {
...
func GetMintTaskResponseDigest(h *cstaskmanager.IIncredibleSquaringTaskManagerTaskResponse) ([32]byte, error) {

	encodeTaskResponseByte, err := AbiEncodeMintTaskResponse(h)
	if err != nil {
		return [32]byte{}, err
	}
